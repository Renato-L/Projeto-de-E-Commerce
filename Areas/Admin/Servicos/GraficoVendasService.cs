...
namespace PaginaLanches.Areas.Admin.Servicos;
...
public class GraficoVendasService
{
    ...
    public List<LancheGrafico> GetVendasLanche(int dias = 360)
    {
        ...
        var lanches = (from pd in _context.PedidoDetalhes join l in _context.Lanches
                       on pd.LancheId equals l.LancheId where pd.Pedido.PedidoEnviado >= data
